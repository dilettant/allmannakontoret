...
2. För en definition av prekärt arbete, se engelska Wikipedia: http://en.wikipedia.org/wiki/Precarious_work [(up)](#foot2)
...
5. För en definition av gentrifiering, se engelska Wikipedia: http://en.wikipedia.org/wiki/Gentrification [(up)](#foot5)
