...
De allmänna kontoren bör ha en eller flera anställda verksamhetsledare, som välkomnar och introducerar användarna till platsen och dess funktioner. Detta kan se ut på olika sätt beroende på verksamhetens form och omfattning, och i vissa fall kan användare hitta sätt att dela på ansvaret som värdar.
...
Öppettider föreslås vara 08.00-22.00 på vardagar, samt 10.00-18.00 på helger. Generösa öppettider är en viktig princip, men det går även att tänka sig Allmänna kontor som måste ha mer begränsade öppettider.
...
* Tillgång till kommunikationsteknolgi spelar en allt större roll i dagens globala samhälle. Långt ifrån alla har i dag tillgång till dator och internetuppkoppling. Därför kan allmänna kontor, i likhet med offentliga bibliotek, innebära en praktisk resurs även för de som saknar tillgång till kommunikationsteknologi i hemmet.
